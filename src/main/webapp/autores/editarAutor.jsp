        ...
        <div class="container" style="margin-top: 20px;">
            <div class="row">
                ...
                <div class="page-header">
                    <h3><i class="fa fa-edit"></i> Editar Autor</h3>
                </div>
                    ...
                    <form role="form" action="${contextPath}/autores.do" method="POST">
                        ...
                        <input type="hidden" class="form-control" name="codigo" readonly  id="codigo" value="${autor.idAutor}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="pais"  value="${autor.pais}" name="pais"  placeholder="Ingresa el nombre del país">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                            </div>
                        </div>
